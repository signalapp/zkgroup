...
impl SystemParams {
    ...
    pub fn get_hardcoded() -> SystemParams {
        let G_b1 = RistrettoPoint::from_uniform_bytes(&[
            244, 94, 240, 129, 130, 81, 96, 23, 245, 231, 110, 46, 198, 110, 199, 195, 123, 17, 2,
            174, 133, 143, 34, 26, 113, 29, 176, 8, 204, 126, 221, 61, 26, 137, 205, 65, 201, 206,
            159, 96, 7, 33, 185, 86, 21, 165, 235, 208, 93, 243, 169, 83, 208, 67, 176, 107, 174,
            64, 137, 126, 185, 208, 61, 50,
        ]);
        let G_b2 = RistrettoPoint::from_uniform_bytes(&[
            41, 59, 89, 94, 166, 78, 191, 238, 79, 121, 188, 80, 42, 227, 91, 91, 243, 76, 63, 17,
            12, 177, 49, 127, 255, 32, 120, 110, 210, 201, 234, 28, 71, 105, 217, 189, 201, 156,
            247, 89, 87, 229, 125, 9, 194, 5, 114, 57, 44, 195, 130, 8, 65, 204, 47, 111, 122, 27,
            75, 1, 172, 219, 148, 42,
        ]);
        SystemParams { G_b1, G_b2 }
    }

...
impl SystemParams {
    ...
    pub fn get_hardcoded() -> SystemParams {
        let G_j1 = RistrettoPoint::from_uniform_bytes(&[134, 214, 189, 20, 105, 109, 71, 88, 227, 219, 43, 97, 86, 177, 67, 210, 199, 254, 19, 79, 84, 122, 219, 173, 106, 18, 48, 36, 44, 247, 138, 90, 88, 22, 145, 123, 71, 140, 178, 62, 85, 104, 78, 169, 5, 242, 233, 19, 157, 176, 2, 3, 136, 197, 38, 112, 126, 226, 38, 85, 236, 79, 146, 61]);
        let G_j2 = RistrettoPoint::from_uniform_bytes(&[127, 159, 160, 191, 181, 50, 6, 252, 13, 64, 148, 133, 101, 163, 224, 135, 13, 34, 29, 224, 20, 101, 154, 7, 169, 169, 243, 147, 189, 47, 227, 185, 62, 225, 76, 118, 214, 80, 126, 243, 80, 31, 66, 44, 225, 116, 22, 230, 84, 230, 74, 235, 37, 220, 162, 123, 177, 126, 100, 193, 57, 22, 72, 158] );
        let G_j3 = RistrettoPoint::from_uniform_bytes(&[154, 183, 149, 157, 112, 18, 114, 86, 206, 19, 115, 66, 14, 58, 51, 228, 202, 173, 31, 142, 232, 131, 35, 93, 62, 233, 83, 155, 50, 244, 244, 106, 65, 150, 169, 148, 129, 32, 165, 53, 1, 139, 57, 45, 99, 193, 168, 111, 138, 245, 212, 154, 252, 26, 169, 101, 186, 49, 54, 63, 116, 253, 112, 111]);
        SystemParams { G_j1, G_j2, G_j3 }
    }
}

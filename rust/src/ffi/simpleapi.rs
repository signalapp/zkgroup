...
pub fn ProfileKey_getCommitment(profileKeyIn: &[u8], uuidIn: &[u8], profileKeyCommitmentOut: &mut [u8]) -> i32 {
...
pub fn ProfileKey_getProfileKeyVersion(profileKeyIn: &[u8], uuidIn: &[u8], profileKeyVersionOut: &mut [u8]) -> i32 {
    let profile_key: api::profiles::ProfileKey = match bincode::deserialize(profileKeyIn) {
        Ok(result) => result,
        Err(_) => return FFI_RETURN_INTERNAL_ERROR,
    };
...
pub fn GroupSecretParams_encryptProfileKeyDeterministic(groupSecretParamsIn: &[u8], randomnessIn: &[u8], profileKeyIn: &[u8], uuidIn: &[u8], profileKeyCiphertextOut: &mut [u8]) -> i32 {
    let group_secret_params: api::groups::GroupSecretParams = match bincode::deserialize(groupSecretParamsIn) {
        Ok(result) => result,
        Err(_) => return FFI_RETURN_INTERNAL_ERROR,
    };
    ...
    let profile_key_ciphertext = group_secret_params.encrypt_profile_key(randomness, profile_key, uuid);
    profileKeyCiphertextOut.copy_from_slice(&bincode::serialize(&profile_key_ciphertext).unwrap());
    FFI_RETURN_OK
}

pub fn GroupSecretParams_decryptProfileKey(groupSecretParamsIn: &[u8], profileKeyCiphertextIn: &[u8], uuidIn: &[u8], profileKeyOut: &mut [u8]) -> i32 {
    let group_secret_params: api::groups::GroupSecretParams = match bincode::deserialize(groupSecretParamsIn) {
        Ok(result) => result,
        Err(_) => return FFI_RETURN_INTERNAL_ERROR,
    };
...
pub fn GroupSecretParams_encryptBlobDeterministic(groupSecretParamsIn: &[u8], randomnessIn: &[u8], plaintextIn: &[u8], blobCiphertextOut: &mut [u8]) -> i32 {
    let group_secret_params: api::groups::GroupSecretParams = match bincode::deserialize(groupSecretParamsIn) {
        Ok(result) => result,
        Err(_) => return FFI_RETURN_INTERNAL_ERROR,
    };

...
pub extern "system" fn Java_org_signal_zkgroup_internal_Native_groupSecretParamsGenerateDeterministicJNI(
    ...
    let ffi_return =
        simpleapi::GroupSecretParams_generateDeterministic(&randomness, &mut group_secret_params);
    if (ffi_return != FFI_RETURN_OK) {
        return ffi_return;
    }
...
pub extern "system" fn Java_org_signal_zkgroup_internal_Native_groupSecretParamsEncryptUuidJNI(
    ...
    let ffi_return =
        simpleapi::GroupSecretParams_encryptUuid(&group_secret_params, &uuid, &mut uuid_ciphertext);
    if (ffi_return != FFI_RETURN_OK) {
        return ffi_return;
    }
...
pub extern "system" fn Java_org_signal_zkgroup_internal_Native_groupSecretParamsDecryptUuidJNI(
    ...
    let ffi_return =
        simpleapi::GroupSecretParams_decryptUuid(&group_secret_params, &uuid_ciphertext, &mut uuid);
    if (ffi_return != FFI_RETURN_OK) {
        return ffi_return;
    }
...
pub extern "system" fn Java_org_signal_zkgroup_internal_Native_groupSecretParamsEncryptBlobJNI(
    ...
    let ffi_return = simpleapi::GroupSecretParams_encryptBlob(
        &group_secret_params,
        &plaintext,
        &mut blob_ciphertext,
    );
...
pub extern "system" fn Java_org_signal_zkgroup_internal_Native_serverSecretParamsGenerateDeterministicJNI(
    ...
    let ffi_return =
        simpleapi::ServerSecretParams_generateDeterministic(&randomness, &mut server_secret_params);
    if (ffi_return != FFI_RETURN_OK) {
        return ffi_return;
    }
...
pub extern "system" fn Java_org_signal_zkgroup_internal_Native_serverPublicParamsCreateAuthCredentialPresentationDeterministicJNI(
    ...
    let ffi_return = simpleapi::ServerPublicParams_createAuthCredentialPresentationDeterministic(
        &server_public_params,
        &randomness,
        &group_secret_params,
        &auth_credential,

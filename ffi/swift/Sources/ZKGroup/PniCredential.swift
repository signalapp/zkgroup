...
public class PniCredential : ByteArray {
  ...
  public init(contents: [UInt8]) throws  {
    try super.init(newContents: contents, expectedLength: PniCredential.SIZE)

    
    let ffi_return = FFI_PniCredential_checkValidContents(self.contents, UInt32(self.contents.count))

...
const library: NativeCalls = Library(libraryPath, {
  ...
  'FFI_ProfileKeyCommitment_getProfileKeyVersion': [ 'int', [ FFICompatArray, 'uint32', FFICompatArray, 'uint32',  ] ],
  ...
  'FFI_GroupSecretParams_signDeterministic': [ 'int', [ FFICompatArray, 'uint32', FFICompatArray, 'uint32', FFICompatArray, 'uint32', FFICompatArray, 'uint32',  ] ],
  ...
  'FFI_GroupSecretParams_encryptProfileKeyDeterministic': [ 'int', [ FFICompatArray, 'uint32', FFICompatArray, 'uint32', FFICompatArray, 'uint32', FFICompatArray, 'uint32', FFICompatArray, 'uint32',   ] ],
  ...
  'FFI_GroupPublicParams_verifySignature': [ 'int', [ FFICompatArray, 'uint32', FFICompatArray, 'uint32', FFICompatArray, 'uint32' ] ],

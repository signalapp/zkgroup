...
public final class Native {
  ...
  public static native int clientZkGroupCipherCheckValidContentsJNI(byte[] self);
  ...
  public static native int clientZkAuthOperationsCheckValidContentsJNI(byte[] self);
  ...
  public static native int clientZkProfileOperationsCheckValidContentsJNI(byte[] self);
  ...
  public static native int serverZkAuthOperationsCheckValidContentsJNI(byte[] self);
  ...
  public static native int serverZkProfileOperationsCheckValidContentsJNI(byte[] self);
